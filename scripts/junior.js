...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function toggleRuleContent(ruleKey) {
    ...
    const ruleValue = spJuniorRules.girls[ruleKey];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function toggleRuleContent(ruleKey) {
    ...
    // Toggle content: clear if the current content matches the selected rule
    const ruleValue = spJuniorRules.boys[ruleKey];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function toggleRuleContent(ruleKey) {
    ...
    // Toggle content: clear if the current content matches the selected rule
    const ruleValue = fpJuniorRules.girls[ruleKey];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function toggleRuleContent(ruleKey) {
    ...
    // Toggle content: clear if the current content matches the selected rule
    const ruleValue = fpJuniorRules.boys[ruleKey];
